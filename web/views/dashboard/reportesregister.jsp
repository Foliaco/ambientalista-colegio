...
<html>
    ...
    <body>
             <div class="nav"><!--index del dashboard-->
                 <a href="/index.jsp"><i class="fas fa-arrow-circle-left"></i>regresar</a>
  ...
  <%
        ...
        <a class="ver" href="../options/public.jsp?id_public=<%= p.getId_posts() %>">Ver publicacion</a>
        <a class="delete" href="../options/archive.jsp?id_public=<%= p.getId_posts() %>">eliminar post</a>
        </div>

...
<div class='post-content'>
    ...
    <div class='header'>
        ...
        <h2><%= name %></h2>
        <h3><a href="/eaci/views/options/public.jsp?id_public=<%= request.getParameter("id_public") %>"><%= request.getParameter("title") %></a></h3>
    ...
    <div class='reaction-content'>
        ...
        if(sesion.getAttribute("name")==null || sesion.getAttribute("rol")==null || sesion.getAttribute("persona")==null){
         %><a href="#" ><i class="far fa-heart"></i></a><%      
            ...
            if(total == 1){
            %><a href="/eaci/control/addLikes.jsp?id_public=<%= request.getParameter("id_public") %>" ><i class="fas fa-heart"></i></a><%    
             }
            else{
            %><a href="/eaci/control/addLikes.jsp?id_public=<%= request.getParameter("id_public") %>" ><i class="far fa-heart"></i></a><%
            }
        ...
        <a href="/eaci/views/options/public.jsp?id_public=<%= request.getParameter("id_public") %>"><i class='fas fa-comment-dots coments'></i></a>
        ...
        if(sesion.getAttribute("name")==null || sesion.getAttribute("rol")==null || sesion.getAttribute("persona")==null){
          %><a href="#"><i class='fas fa-exclamation-circle report'></i></a><%    
            ...
            if(reporttotal == 1){
            %><a href="/eaci/control/addreport.jsp?id_pub=<%= request.getParameter("id_public") %>"><i class='fas fa-exclamation-circle report'></i>reportada</a><%    
             }
            else{
            %><a href="/eaci/control/addreport.jsp?id_pub=<%= request.getParameter("id_public") %>"><i class='fas fa-exclamation-circle report'></i>reportar</a><%    
            }
